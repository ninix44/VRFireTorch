...
public class VROverlayFireTorch extends VROverlayScreen {
    public static final String ID = "firetorch";


    public VROverlayFireTorch(@NotNull VisorAddon owner, @NotNull String id) {
        super(owner, id);
